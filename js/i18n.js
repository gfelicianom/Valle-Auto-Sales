...
const I18N = {
  es: {
    ...
    family_line: "Familia de Aguada sirviendo a Puerto Rico",
    family_since: "Desde 1992",
    ...
    cylinders_short: "{n} cil.",
    cylinders_long: "{n} cilindros",

    // Powertrain
    drive_fwd: "FWD — delantera",
    drive_rwd: "RWD — trasera",
    drive_awd: "AWD — integral",
    drive_4wd: "4WD — tracción en las cuatro ruedas",
    drive_4x4: "4x4",
    drive_4x2: "4x2",
    ...
    fuel_diesel: "Diésel",
    fuel_hybrid: "Híbrido",
    fuel_plug_in_hybrid: "Híbrido enchufable",
    ...
    d_whatsapp: "WhatsApp",
    d_call: "Llamar",
    gal_prev: "Foto anterior",
    gal_next: "Siguiente foto",
    d_wa_msg: "Hola, me interesa el {car} que vi en su página web.",
    d_notes: "Notas",
    ...
    fin_financing_title: "Financiamiento",
    fin_financing_text: "Financiamiento disponible aquí mismo en el dealer — trabajamos con usted y con su banco.",
    fin_talk_title: "¡Hablemos!",
    fin_talk_text: "Escríbanos o llámenos — con gusto le atendemos. Si es fuera de horas, déjenos sus datos abajo y le devolvemos la llamada.",
    fin_wa_msg: "Hola, me gustaría información sobre sus autos.",
    fin_wa_msg_car: "Hola, me gustaría información sobre: {car}",
    fin_form_title: "¿Interesado? Déjenos sus datos",
    fin_form_sub: "Complete este formulario y nos comunicamos con usted para confirmar los detalles.",
    fin_name: "Nombre completo",
    fin_phone: "Teléfono",
    fin_email: "Email",
    fin_car: "Auto de interés",
    fin_car_ph: "Ej: Toyota Corolla 2019 — o díganos qué busca",
    fin_payment: "Forma de pago",
    fin_payment_select: "Seleccione…",
    fin_pay_cash: "Al contado (cash)",
    fin_pay_financing: "Financiamiento",
  ...
  en: {
    ...
    family_line: "An Aguada family serving Puerto Rico",
    family_since: "Since 1992",
    ...
    cylinders_short: "{n} cyl.",
    cylinders_long: "{n} cylinders",

    drive_fwd: "FWD — front-wheel drive",
    drive_rwd: "RWD — rear-wheel drive",
    drive_awd: "AWD — all-wheel drive",
    drive_4wd: "4WD — four-wheel drive",
    drive_4x4: "4x4",
    drive_4x2: "4x2",
    ...
    gal_next: "Next photo",
    d_wa_msg: "Hi, I'm interested in the {car} I saw on your website.",
    d_notes: "Notes",
    ...
    fin_financing_title: "Financing",
    fin_financing_text: "Financing is available right here at the dealership — we'll work with you and your bank.",
    fin_talk_title: "Let's talk!",
    fin_talk_text: "Message us or give us a call — we're happy to help. If it's after hours, leave your info below and we'll call you back.",
    fin_wa_msg: "Hi, I'd like some information about your cars.",
    fin_wa_msg_car: "Hi, I'd like some information about: {car}",
    fin_form_title: "Interested? Leave us your info",
    fin_form_sub: "Fill out this form and we'll contact you to confirm the details.",
    fin_name: "Full name",
    fin_phone: "Phone",
    fin_email: "Email",
    ...
    fin_payment_select: "Select…",
    fin_pay_cash: "Cash",
    fin_pay_financing: "Financing",
